    ...
    <div className="max-h-[600px] overflow-y-auto rounded-xl bg-gradient-to-b from-black/40 via-black/30 to-black/40 p-6 border border-white/20 shadow-lg">
      <ul className="space-y-3">
        {[
          ...
          { time: "01:28", event: "Password change request submitted for account 'j.taylor'" },
          ...
          { time: "02:18", event: "Log clearing commands executed on HELIX-APP02 (/var/log/secure truncated) by account 'j.taylor'" },
    ...
    <div className="bg-black/60 rounded-lg p-4 font-mono text-sm max-h-[600px] overflow-y-auto">
      <div className="space-y-1">
        {[
          ...
          "Sep  8 23:55:02 webserver sshd[12456]: Failed password for j.taylor from 192.168.1.45 port 52341 ssh2",
          "Sep  8 23:57:18 webserver sshd[12489]: Failed password for j.taylor from 192.168.1.45 port 52358 ssh2",
          ...
          "Sep  9 01:33:21 webserver sshd[13501]: Accepted password for j.taylor from 10.0.0.9 port 54021 ssh2",
          "Sep  9 01:34:12 webserver sshd[13504]: PAM: authentication info for user=j.taylor",
          ...
          "Sep  9 02:05:33 webserver sshd[14567]: Accepted password for j.taylor from 192.168.1.45 port 52501 ssh2",
          "Sep  9 02:05:34 webserver pam_unix(sshd:session): session opened for user j.taylor by (uid=0)",
          "Sep  9 02:05:47 webserver sudo:   j.taylor : TTY=pts/3 ; PWD=/home/j.taylor ; USER=root ; COMMAND=/bin/cp /home/j.taylor/helix_specs.txt /tmp/",
          "Sep  9 02:06:12 webserver scp[14590]: /home/j.taylor/helix_specs.txt -> /tmp/helix_specs.txt",
          ...
          "Sep  9 02:11:18 webserver sudo:   j.taylor : TTY=pts/4 ; PWD=/home/j.taylor ; USER=root ; COMMAND=/usr/bin/shred /tmp/helix_specs.txt",
          "Sep  9 02:12:02 webserver audit[14678]: ANOMALY: logrotate truncated /var/log/secure by user j.taylor",
          "Sep  9 02:15:42 webserver sshd[14568]: pam_unix(sshd:session): session closed for user j.taylor",
          "Sep  9 02:17:09 webserver systemd[1]: Stopping Session 123 of user j.taylor.",
          ...
          "Sep  9 03:22:05 webserver sudo:   j.taylor : TTY=pts/6 ; PWD=/home/j.taylor ; USER=root ; COMMAND=/usr/bin/powershell -ExecutionPolicy Bypass -File /tmp/exec.ps1",
